...
`{dmhct}` exists only on Github and is currently a private repository. This means
that you will need to verify your identity to install it, which is most easily
done by setting up a Github PAT for your local machine. See
...
this document. Note that you will need to set up a Github account and Github PAT
to do so, since this repository is currently private.
